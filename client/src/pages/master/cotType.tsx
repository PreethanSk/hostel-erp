...
import { Button, Checkbox, FormControlLabel, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, } from "@mui/material";
import { CustomAlert, customTableHeader, customTableTemplate, getExportEXCEL, textFieldStyle } from "../../services/HelperService";
import { deleteMasterCotType, getMasterCotType, insertUpdateMasterCotType } from "../../models";
...
export default function Index({ PageAccess }: any) {
  ...
  const handleSubmitForm = () => {
    ...
    insertUpdateMasterCotType(body)
      .then((resp) => {
        if (resp?.data?.status === "success") {
          getGridList();
          handleGoBack();
  ...
  const getPrintTableHeadBody = () => {
    const header = ["S. No", "Cot Name", "Status"];
  ...
  const exportEXCEL = () => {
    ...
    getExportEXCEL({ header, body, fileName: "Cot Type" })
  };
        ...
        <>
          <div className="row justify-content-between align-items-center py-3">
            <div className="col-md-4 my-2 d-flex align-items-center gap-2">
              ...
              <span className="text-muted">Cot Type</span>
            </div>
            ...
            <Table sx={{ ...customTableTemplate }}>
              <TableHead>
                <TableRow sx={{ ...customTableHeader }}>
                  ...
                  <TableCell className="fw-bold">Cot Name</TableCell>
