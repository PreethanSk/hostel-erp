...
import { deleteMasterRoomType, getMasterRoomType, insertUpdateMasterRoomType, } from "../../models";
...
export default function Index({ PageAccess }: any) {
  ...
  const handleSubmitForm = () => {
    ...
    insertUpdateMasterRoomType(body)
      .then((resp) => {
        if (resp?.data?.status === "success") {
          getGridList();
          handleGoBack();
  ...
  const exportEXCEL = () => {
    ...
    getExportEXCEL({ header, body, fileName: "Room Type" })
  };
            ...
            <div className="my-2 col-md-6">
              <div className="d-flex justify-content-end align-items-center gap-4 mobJustify">
                <div className="line-item">
                  <Button className="text-capitalize" sx={{ color: "black" }}
        ...
        {_editForm && (
          <div className="container py-3">
            <div className="bg-field-gray  border rounded px-4 py-1">
              <div className="d-flex align-items-center py-2 borderBottomLight"
                role="button" onClick={handleGoBack}>
